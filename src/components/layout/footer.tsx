        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <Link href="#" className="hover:text-[#00FFEF] transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products" className="hover:text-[#00FFEF] transition-colors duration-200">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#00FFEF] transition-colors duration-200">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/cart" className="hover:text-[#00FFEF] transition-colors duration-200">
                  Cart
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-[#00FFEF]" />
                <span className="text-sm">+254 751 030 250</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-[#00FFEF]" />
                <span className="text-sm">info@davietech.com</span>
              </div>
              <div className="flex items-start space-x-2">
                <MapPin className="h-4 w-4 text-[#00FFEF] mt-0.5" />
