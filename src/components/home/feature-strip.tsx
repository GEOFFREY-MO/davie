    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="flex items-center space-x-3 bg-white/10 border border-white/20 rounded-xl p-4">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
              <ShoppingBag className="h-5 w-5 text-white" />
            </div>
            <div>
              <h3 className="font-semibold text-white">Wide Selection</h3>
              <p className="text-sm text-white/80">Thousands of products</p>
            </div>
          </div>
          <div className="flex items-center space-x-3 bg-white/10 border border-white/20 rounded-xl p-4">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">Same day delivery</p>
            </div>
          </div>
          <div className="flex items-center space-x-3 bg-white/10 border border-white/20 rounded-xl p-4">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
